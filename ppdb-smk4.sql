/*
 ...
 Source Schema         : ppdb-online-ci4

 Target Server Type    : MySQL
 Target Server Version : 50736
 File Encoding         : 65001

 Date: 07/09/2022 05:48:55
*/
...
INSERT INTO `tbl_agama` VALUES (2, 'Protestan');
INSERT INTO `tbl_agama` VALUES (3, 'Khatolik');
INSERT INTO `tbl_agama` VALUES (4, 'Hindu');
INSERT INTO `tbl_agama` VALUES (5, 'Budha');
INSERT INTO `tbl_agama` VALUES (6, 'Konghucu');
...
CREATE TABLE `tbl_baner`  (
  ...
  `baner` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id_baner`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of tbl_baner
-- ----------------------------
INSERT INTO `tbl_baner` VALUES (1, 'Baner 1', 'baner1.jpg');
INSERT INTO `tbl_baner` VALUES (2, 'Baner 2', 'baner2.jpg');
INSERT INTO `tbl_baner` VALUES (3, 'Baner 3', 'baner3.jpg');
INSERT INTO `tbl_baner` VALUES (4, 'Baner 4', 'baner4.jpg');
...
CREATE TABLE `tbl_berkas`  (
  ...
  `id_lampiran` int(2) NULL DEFAULT NULL,
  `ket` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `berkas` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `tbl_berkas` VALUES (1, 13, 6, 'Sertifikat Seminar', 'sertifikat.pdf');
INSERT INTO `tbl_berkas` VALUES (2, 13, 3, 'SKHUN', 'skhun.pdf');

-- ----------------------------
-- Table structure for tbl_jalur_masuk
-- ----------------------------
DROP TABLE IF EXISTS `tbl_jalur_masuk`;
CREATE TABLE `tbl_jalur_masuk`  (
  `id_jalur_masuk` int(2) NOT NULL AUTO_INCREMENT,
  `jalur_masuk` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `kuota` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id_jalur_masuk`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of tbl_jalur_masuk
-- ----------------------------
INSERT INTO `tbl_jalur_masuk` VALUES (1, 'Zonasi', 50);
INSERT INTO `tbl_jalur_masuk` VALUES (2, 'Prestasi', 10);
INSERT INTO `tbl_jalur_masuk` VALUES (3, 'Afirmasi', 5);
INSERT INTO `tbl_jalur_masuk` VALUES (4, 'Perpindahan', 10);
...
-- ----------------------------
INSERT INTO `tbl_jurusan` VALUES (1, 'Teknik Listrik');
INSERT INTO `tbl_jurusan` VALUES (2, 'Teknik Komputer Jaringan');
INSERT INTO `tbl_jurusan` VALUES (3, 'Teknik Elekto');
INSERT INTO `tbl_jurusan` VALUES (4, 'Otomotif');
INSERT INTO `tbl_jurusan` VALUES (5, 'Rekayasa Perangkat Lunak');
INSERT INTO `tbl_jurusan` VALUES (6, 'IPA');
INSERT INTO `tbl_jurusan` VALUES (7, 'IPS');
...
CREATE TABLE `tbl_lampiran`  (
  `id_lampiran` int(2) NOT NULL AUTO_INCREMENT,
  `lampiran` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id_lampiran`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of tbl_lampiran
-- ----------------------------
INSERT INTO `tbl_lampiran` VALUES (1, 'Kartu Keluraga');
INSERT INTO `tbl_lampiran` VALUES (2, 'Ijazah');
INSERT INTO `tbl_lampiran` VALUES (3, 'SKHUN');
INSERT INTO `tbl_lampiran` VALUES (4, 'KTP');
INSERT INTO `tbl_lampiran` VALUES (5, 'Akta Kelahiran');
INSERT INTO `tbl_lampiran` VALUES (6, 'Sertifikat');
INSERT INTO `tbl_lampiran` VALUES (7, 'KIP');
...
INSERT INTO `tbl_pekerjaan` VALUES (6, 'Lain-Lain');
...
-- ----------------------------
INSERT INTO `tbl_pendidikan` VALUES (1, 'Tidak Tamat SD');
...
-- ----------------------------
INSERT INTO `tbl_penghasilan` VALUES (1, 'Rp.0 s/d Rp.500,000');
INSERT INTO `tbl_penghasilan` VALUES (2, 'Rp.500,000 s/d Rp.1.000,000');
INSERT INTO `tbl_penghasilan` VALUES (3, 'Rp.1,000,000 s/d Rp.1,500,000');
INSERT INTO `tbl_penghasilan` VALUES (4, 'Rp.1,500,000 s/d Rp.2,000,000');
INSERT INTO `tbl_penghasilan` VALUES (6, 'Rp.2,000,000 s/d Rp.2,500,000');
INSERT INTO `tbl_penghasilan` VALUES (7, 'Rp.2,500,000 s/d Rp.3,000,000');
INSERT INTO `tbl_penghasilan` VALUES (8, 'Rp.3,000,000 s/d Rp.3,500,000');
INSERT INTO `tbl_penghasilan` VALUES (9, 'Rp.3,500,000 s/d Rp.4,000,000');
INSERT INTO `tbl_penghasilan` VALUES (10, '> Rp.4,000,000');
...
CREATE TABLE `tbl_setting`  (
  ...
  `kecamatan` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  `no_telpon` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  ...
  `beranda` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
...
-- ----------------------------
INSERT INTO `tbl_setting` VALUES (1, 'SMKN 1 Padang', 'Jl. Diponegoro No.10', 'Sumatera Barat', 'Kota Padang', 'Padang Timur', '0822839232', 'smkn1padang@gmail.com', 'https://www.smkn1padang.sc.id', 'Sekolah Favorite', '1612693753_72bfb14c173d7ccd8237.png', '                    <h4 style=\"text-align: center; \"><b><font color=\"#0000ff\">PPDB Online SMKN 1 Padang TA 2020/2021</font></b></h4><div><b><br></b>\r\n</div><div>adalah sebuah Sistem Layanan yang dirancang untuk memfasilitasi otomasi pelaksanaan Penerimaan Peserta Didik Baru (PPDB), dari proses pendaftaran, seleksi hingga pengumuman hasil seleksi berbasis waktu nyata melalui Internet.</div><div><br></div><div><b>Persyaratan calon peserta didik baru kelas 7 (tujuh)&nbsp;</b><span style=\"font-weight: bolder;\">SMK&nbsp;</span><b>atau bentuk lain yang sederajat:</b><br><ol><li>Berusia paling tinggi 15 (lima belas) tahun pada tanggal 1 Juli tahun berjalan;</li><li>Memiliki akta kelahiran. Bagi calon peserta didik yang pada saat pendaftaran belum memiliki, dapat diganti dengan surat keterangan lahir dan surat pernyataan kesanggupan dari orang tua/wali untuk mengurus akta paling lambat pada semester 2 (dua);</li><li>Melampirkan Kartu Keluarga atau surat keterangan domisili yang diterbitkan paling lambat 6 (enam) bulan sebelum pelaksanaan PPDB;</li><li>Melampirkan piagam/sertifikat prestasi bagi calon peserta didik yang mendaftar melalui jalur prestasi;</li><li>Melampirkan surat penugasan orang tua/wali bagi calon peserta didik yang mendaftar melalui jalur perpindahan tugas orang tua/wali; dan</li><li>Membuat surat pernyataan tentang kebenaran dokumen yang diserahkan.</li><li>Bagi calon peserta didik penyandang disabilitas di sekolah yang menyelenggarakan layanan inklusif dan/atau calon peserta didik dari keluarga tidak mampu yang dibuktikan dengan keikutsertaan dalam program penanganan keluarga tidak mampu dari Pemerintah Pusat maupun Pemerintah Daerah</li></ol></div><div><b>Syarat khusus <br></b></div><ol><li>Calon peserta berusia paling tinggi 15 tahun pada tanggal 1 Juli tahun berjalan. </li><li>Memiliki ijazah SD/sederajat atau dokumen lain yang menjelaskan telah menyelesaikan kelas 6 SD. </li></ol><div><b>Syarat umum <br></b></div><ol><li>Untuk syarat usia harus dibuktikan dengan akta kelahiran atau surat keterangan lahir yang dikeluarkan oleh pihak yang berwenang dan dilegalisir oleh lurah/kepala desa atau pejabat setempat lain sesuai dengan domisili calon peserta didik. </li><li>Bagi warga negara Indonesia (WNI) atau warga negara asing (WNA) serta berasal dari sekolah di luar negeri, selain memenuhi persyaratan, juga wajib mendapatkan surat keterangan dari direktur jenderal yang menangani bidang pendidikan dasar dan menengah. </li><li>Peserta didik WNA wajib mengikuti matrikulasi pendidikan Bahasa Indonesia paling singkat 6 bulan yang diselenggarakan oleh sekolah yang bersangkutan. </li><li>Khusus calon peserta didik penyandang disabilitas di sekolah juga dikecualikan dari syarat usia serta ijazah atau dokumen lain. </li></ol><div><b>Jalur zonasi (50 persen) <br></b></div><ol><li>Diperuntukkan bagi peserta didik berdomisili di dalam wilayah zonasi yang ditetapkan pemerintah daerah. Kuota ini termasuk bagi anak penyandang disabilitas. </li><li>Domisili calon peserta didik berdasarkan alamat pada kartu keluarga yang diterbitkan paling singkat 1 tahun sejak tanggal pendaftaran PPDB. </li><li>Sekolah memprioritaskan peserta didik yang memiliki KK atau surat keterangan domisili dalam satu wilayah kabupaten/kota yang sama dengan sekolah asal. </li></ol><div><b>Jalur afirmasi (15 persen) <br></b></div><ol><li>Jalur ini diperuntukkan bagi peserta didik berasal dari keluarga ekonomi tidak mampu. </li><li>Harus dibuktikan dengan bukti keikuts ertaan peserta didik dalam program penanganan keluarga tidak mampu dari pemerintah pusat/daerah (Kartu Indonesia Pintar dan sejenisnya). </li><li>Merupakan peserta didik yang berdomisili di dalam dan di luar wilayah zonasi sekolah bersangkutan. </li><li>Bukti keikutsertaan dalam program penanganan keluarga tidak mampu dari pemerintah pusat/daerah wajib dilengkapi dengan surat pernyataan dari orangtua/wali. Isinya menyatakan bersedia diproses hukum apabila terbukti memalsukan bukti keikutsertaan. </li><li>Jika terdapat dugaan pemalsuan bukti keikut sertaan dalam program penanganan keluarga tidak mampu dari pemerintah pusat/daerah wajib melakukan verifikasi data dan lapangan serta menindak lanjuti hasil verifikasi sesuai dengan ketentuan perundang-undangan. </li></ol><div><b>Jalur perpindahan tugas orangtua/wali (5 persen) <br></b></div><ol><li>Perpindahan tugas orangtua/wali dibuktikan dengan surat penugasan dari instansi, lembaga, kantor, atau perusahaan yang mempekerjakan. Kuota jalur ini dapat digunakan untuk anak guru. </li></ol><div><b>Jalur prestasi (30 persen) <br></b></div><ol><li>Ditentukan berdasarkan nilai ujian sekolah atau UN; dan atau </li><li>Hasil perlombaan dan atau penghargaan di bidang akademik maupun non-akademik pada tingkat internasional, nasional, provinsi, dan atau tingkat kabupaten/kota. </li><li>Bukti atas prestasi hasil perlombaan/penghargaan itu diterbitkan paling singkat 6 bulan, dan paling lama 3 tahun sejak tanggal pendaftaran PPDB</li></ol>                    ');
...
CREATE TABLE `tbl_siswa`  (
  ...
  `no_pendaftaran` varchar(14) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `tgl_pendaftaran` date NULL DEFAULT NULL,
  `tahun` year NULL DEFAULT NULL,
  `id_jurusan` int(2) NULL DEFAULT 0,
  ...
  `nama_panggilan` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  ...
  `id_jalur_masuk` int(2) NULL DEFAULT NULL,
  `foto` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `nik` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `id_agama` int(2) NULL DEFAULT NULL,
  `no_telpon` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `tinggi` int(4) NULL DEFAULT NULL,
  `berat` int(4) NULL DEFAULT NULL,
  `jml_saudara` int(4) NULL DEFAULT NULL,
  `anak_ke` int(4) NULL DEFAULT NULL,
  ...
  `pendidikan_ayah` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `pekerjaan_ayah` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `penghasilan_ayah` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `no_telpon_ayah` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  ...
  `pendidikan_ibu` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `pekerjaan_ibu` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `penghasilan_ibu` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `no_telpon_ibu` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `id_provinsi` int(2) NULL DEFAULT NULL,
  `id_kabupaten` int(3) NULL DEFAULT NULL,
  `id_kecamatan` int(4) NULL DEFAULT NULL,
  `alamat` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `nama_sekolah_asal` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  ...
  `no_skhun` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `stat_pendaftaran` int(1) NULL DEFAULT 0,
  `stat_ppdb` int(1) NULL DEFAULT 0,
...
-- ----------------------------
INSERT INTO `tbl_siswa` VALUES (13, '202102100001', '2021-02-10', 2021, 7, '1122334455', 'Putri Ani', 'Puti', 'Padang', '2021-02-01', 'P', '1122334455', 2, '1613653478_1be28ddd5cb0531dc1e8.jpg', '111111111111111', 1, '082222222222', 150, 60, 3, 1, '111111111', 'Budi', 'S1', 'PNS', 'Rp.2,500,000 s/d Rp.3,000,000', '23423423424', '22222222', 'ani ani', 'D1', 'Lain-Lain', 'Rp.0 s/d Rp.500,000', '082828282', 13, 1302, 1302040, 'Jl. Lintas Sumatra No.10', 'SMPN 1 Padang', 2020, '13123123123123', '1231231313123', 1, 1);
INSERT INTO `tbl_siswa` VALUES (14, '202102100002', '2021-02-10', 2021, 0, '0123456789', 'Budi Suherman', 'Budi', 'Air Haji', '2001-06-14', 'L', '0123456789', 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1);
INSERT INTO `tbl_siswa` VALUES (18, '202102100003', '2021-02-10', 2021, 0, '1111111111', 'Budi', 'Handoko', 'Air Haji', '1998-10-15', 'L', '1111111111', 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0);
INSERT INTO `tbl_siswa` VALUES (21, '202102110001', '2021-02-11', 2021, 0, '5555555', 'Padang Tekno', 'PT', 'asddas', '2002-07-12', 'P', '5555555', 4, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0);
INSERT INTO `tbl_siswa` VALUES (25, '202103130001', '2021-03-13', 2021, 0, '999999999', '999999999', '999999999', '999999999', '2006-10-16', 'L', '999999999', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0);

-- ----------------------------
-- Table structure for tbl_ta
-- ----------------------------
DROP TABLE IF EXISTS `tbl_ta`;
CREATE TABLE `tbl_ta`  (
  `id_ta` int(11) NOT NULL AUTO_INCREMENT,
  `tahun` year NULL DEFAULT NULL,
  `ta` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `status` int(1) NULL DEFAULT 0,
  `pendaftaran` int(1) NULL DEFAULT NULL,
...
-- Records of tbl_ta
-- ----------------------------
INSERT INTO `tbl_ta` VALUES (1, 2018, '2018/2019', 0, 0);
INSERT INTO `tbl_ta` VALUES (2, 2019, '2019/2020', 0, 0);
INSERT INTO `tbl_ta` VALUES (3, 2020, '2010/2021', 0, 0);
INSERT INTO `tbl_ta` VALUES (4, 2021, '2021/2022', 0, 0);
INSERT INTO `tbl_ta` VALUES (9, 2022, '2022/2023', 1, 0);
...
-- Records of tbl_user
-- ----------------------------
INSERT INTO `tbl_user` VALUES (1, 'Administrator', 'admin@gmail.com', '1234', '1612630963_471a828a0570ffed6c9e.png');
INSERT INTO `tbl_user` VALUES (2, 'Mardalius', 'mardalius18@gmail.com', '1234', 'user.jpg');
